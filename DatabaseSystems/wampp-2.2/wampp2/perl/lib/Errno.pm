...
@EXPORT_OK = qw(EROFS ESHUTDOWN EPROTONOSUPPORT ENFILE ENOLCK
	...
	ELOOP ECONNREFUSED EISCONN EFBIG ENOENT EPFNOSUPPORT ECONNRESET
	EDISCON EWOULDBLOCK EDOM EMSGSIZE ENOSPC EIO ENOTSOCK EDESTADDRREQ
	ERANGE EINPROGRESS ENOBUFS EADDRNOTAVAIL EAFNOSUPPORT ENOSYS EINTR
	EHOSTDOWN EILSEQ EREMOTE ENOMEM ENOTCONN ENETUNREACH EPIPE ESTALE
	EDQUOT EUSERS EOPNOTSUPP ESPIPE EALREADY ENAMETOOLONG EMFILE EACCES
	ENOEXEC EISDIR EPROCLIM EBUSY E2BIG EPERM EEXIST ETOOMANYREFS
	ESOCKTNOSUPPORT ETIMEDOUT ENXIO ESRCH EFAULT ENODEV EDEADLOCK EAGAIN
	EMLINK ENOPROTOOPT ECHILD ENETDOWN EHOSTUNREACH EPROTOTYPE ENETRESET
	ENOTEMPTY);
