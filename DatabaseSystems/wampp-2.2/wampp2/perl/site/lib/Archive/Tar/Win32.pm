...
sub write {
    ...
    return write_tar $file, $compressed, @{$self->{'_data'}};
}
...
Due to the nature of the Win32 environment, Archive::Tar falls back to
an older version. Although less in features, it's proven to work.
