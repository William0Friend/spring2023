...
// Ver:		$Id: jpgraph.php,v 1.226 2003/04/11 20:34:28 aditus Exp $
//
...
//
// WINDOWS:
// CACHE_DIR = "/wampp2/tmp/"
// TTF_DIR   = $SERVER_SYSTEMROOT/fonts/
// CACHE_DIR = "/wampp2/tmp/"
// TTF_DIR   = "/wampp2/htdocs/fonts/"
//    
//
//------------------------------------------------------------------------
...
// Must end with '/'
 DEFINE("CACHE_DIR","/wampp2/tmp/");

// Directory for jpGraph TTF fonts. Must end with '/'
 DEFINE("TTF_DIR","/wampp2/htdocs/fonts/");
...
DEFINE("CSIMCACHE_DIR","/wampp2/tmp/"); 
...
class Legend {
    ...
    var $txtcol=array();
    var $mark_abs_size=9,$xmargin=10,$ymargin=6,$shadow_width=2;
