...
<hr>
<big><a name="conf_overview"></a><b>6.1. <font color=#ee0000>Overview</font></b></big><p>


Spyce (the core engine and all the standard modules) currently requires
<b>Python version 2.2 or greater</b>. Spyce uses no version-specific Apache features. <p>
...
<a href=doc-runtime_common.html>Spyce configuration module</a>.
